...
summary: Scan every repo on the machine for guardrails, testing, and observability conformance; audit the deltas semantically; produce a fleet report; and propose canary-first remediation.
scope: universal
invokes: [project-init, failure-mode-capture, slop-check]
---
