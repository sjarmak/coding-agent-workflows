---
name: project-init
summary: Stand up the context layers for a project — a thin pointer-style AGENTS.md plus seed compass maps — without touching the memory layer.
scope: universal
invokes: [codebase-onboarding, project-compass]
---
