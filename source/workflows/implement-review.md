...
summary: One agent implements a task, then reviews its own work behind a hard verification gate before finalizing.
scope: universal
invokes: [focus, simplify, code-review]
ported-from: mol-focus-review (Gas City formula, runtime mechanics removed)
---
