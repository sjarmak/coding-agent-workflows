---
name: simplify
description: Reduce a diff to its essential complexity — remove dead paths, over-engineering, premature abstraction, and incidental churn — without changing behavior.
scope: universal
