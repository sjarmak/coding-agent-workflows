---
name: handoff-doc
description: "Write a handoff document to a handoff directory so a new agent session can be pointed at the file, read it, and delete it. Use when nearing context limits or starting fresh while preserving context. Triggers on: handoff doc, file handoff, write handoff, new session, continue in new thread."
scope: universal
---
