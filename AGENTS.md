...
Coding standards, agent roles, skills, and workflows that read the same across coding agents. 
Claude Code reads `targets/claude/`; Codex reads this file plus `targets/codex/`; 
any agent that reads `AGENTS.md` (Amp, Aider, Gemini CLI, and others) gets the universal layer below.
