...
//   - AGENTS.md          universal entry point (Codex, Amp, Cody, anything that reads AGENTS.md)
...
write(path.join(X, 'config.toml'),
  `# Codex configuration — agentic-coding-practices\n` +
...
parts.push('');
parts.push('A curated, agent-neutral set of coding practices, agent roles, skills, and workflows. ');
parts.push('Claude Code reads `targets/claude/`; Codex reads this file plus `targets/codex/`; ');
parts.push('any agent that reads `AGENTS.md` (Amp, Cody, Aider, Gemini CLI, …) gets the universal layer below.');
parts.push('');
